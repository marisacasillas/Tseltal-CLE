...
# quantity.rand$stthr.tri <- factor(
#   quantity.rand$stthr.tri,
#   levels = c("midday", "morning", "afternoon"))
# quantity.rand$stthr.tri.a <- factor(
#   quantity.rand$stthr.tri,
#   levels = c("afternoon", "midday", "morning"))
# quantity.rand$stthr.tri.o <- factor(
#   quantity.rand$stthr.tri,
