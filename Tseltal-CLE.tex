...
\includegraphics[width=\textwidth]{Tseltal-CLE_files/figure-latex/fig1-1}
\textbackslash{}caption\{By-child estimates for minutes per hour of all
...
= purple). Boxplots indicate variance in each measure across the nine
5-minute random clips. Bands on the linear trends show 95\%
CIs.\}\label{fig:fig1} \textbackslash{}end\{figure\}
