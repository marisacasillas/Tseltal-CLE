...
the random ones (\protect\hyperlink{fig3}{Figures 3} and
\protect\hyperlink{fig5}{5}).
...
Finally, whereas the number of speakers present had significantly
impacted both TCDS and ODS rate in the random sample, it only
significantly impacted ODS rate in the turn-taking sample (random
sample: B = 0.71, SD = 0.11, z = 6.63, p \textless{} 0.001). This result
suggests that the number of speakers is a robust predictor of ODS
quantity across different contexts. Full model outputs are available in
...
(summarized in \protect\hyperlink{fig9}{Figure 9}) for the proportional
...
9}: there is a decline in the use of non-canonical babble and an
