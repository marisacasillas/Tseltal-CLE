...
in which TCDS is known to be more frequent (Fine \& Lieven, 1993; Frank
...
(Brown, 1998b, 1998a, 2011, 2014; Brown \& Gaskins, 2014). In short,
more and more diverse data are needed to enrich this initial description
of Tseltal children's language environments. Importantly, the current
analyses are based on a corpus that is still under active development:
as new data are added, up-to-date versions of these analyses will be
available with the current data and analysis scripts can be found:
ADD-URL.
...
Mendez Guzman, and Antun Gusman Osil, who made the collection and
