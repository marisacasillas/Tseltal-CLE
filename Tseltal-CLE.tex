...
hear TCDS in the mornings than around midday (B = 0.82, SD = 0.40, z =
2.06, p = 0.04), with no difference between morning and afternoon (p =
0.29) or midday and afternoon (p = 0.19). Time-of-day effects varied by
...
(B = 0.73, SD = 0.36, z = 2.04, p = 0.04) and marginally more likely to
...
compared to younger children (B = 0.61, SD = 0.20, z = 3.06, p
