...
factors relating to the time of day. The count model showed that the
...
0.19) TCDS rates. Time of day effects varied by age: compared to the
afternoons, during which children showed similar TCDS rates across age,
older children were significantly more likely than younger children to
hear TCDS at midday (B = 0.73, SD = 0.36, z = 2.04, p = 0.04) and
marginally more likely than younger children to hear TCDS in the morning
(B = 0.46, SD = 0.28, z = 1.65, p = 0.10; see
\protect\hyperlink{fig5}{Figure 5}). Older target children were also
significantly more likely to hear TCDS when more speakers were present,
compared to younger children (B = 0.61, SD = 0.20, z = 3.06, p = 0).
