...
## Vocal maturity
Past ethnographic work reported that children in some infrequent-CDS environments show no evidence of language delay [e.g., @brown2011cultural; @brown2014interactional; @brown2014language; @liszkowski2012prelinguistic]. We test this claim by comparing Tseltal children's achievement of major speech production milestones to those already known for Western children [REFS]. In so doing, we report on the 'vocal maturity' of Tseltal children's spontaneous speech. Our vocal maturity measure is designed to capture the transition from (a) non-canonical babble to canonical babble, (b) canonical babble to first words, and (c) single-word utterances to multi-word speech utterances. This measure is, at best, a coarse approximation of children's true linguistic abilities, but it is an efficient means for getting a bird's eye view of children's speech as it becomes more linguistically complex over the first three years.
...
Importantly, children's vocal maturity may be more subject to environmental factors as they grow older. The onset of canonical babbling during the first year appears stable in response to wide variation in linguistic experience [in typically developing children; REFS; Oller et al., 1994, 1995, 1997; Lee et al., 2018]. Most children are also reported to produce a small number of words by their first birthday. 

stability in language learning >> small differences getting bigger?

However, ~XX% of children do not reach this 1-year benchmark for first words

and some very early differences in vocabulary size have a demonstrated association with SES.

The transition between canonical babbling and first words may also be subject to children's experience with language. First words often closely phonologically approximate non-word babbling [Stoel-Gammon and Cooper, 1984], and the size and growth of children's early vocabulary is impacted by language experience indices such as SES, birth order, and language (REFS; WORDBANK??). As mentioned above, early vocabulary size is also crosslinguistically a robust predictor of their early syntactic development [@frankIPvariability; @marchman2004language], and vocabulary size and syntactic complexity have both been linked to children's experience with high frequency and high quality CDS in the past.
<!--However, the _rate_ of infant vocalization does vary across developmental environments [Oller et al., 1994, 1995], possibly influencing the quantity and type of CDS children hear from caregivers [Warlaumont et al., 2014; McGillion et al., 2017]; early differences in babbling rate could predict later lexical and syntactic development-->
