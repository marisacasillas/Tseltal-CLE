...
## How much directed speech do Tseltal children receive?
...
- Warlaumont 2014: child initiations slightly higher than parent ones in WEIRD kids
- Warlaumont 2016: reward-modulated neural plasticity model---infants may bootstrap their way to higher vocmat by learning from their own, more salient vocalizations + those produced by the people around them (which, in turn, are increased in frequency by the kids' own productions; linking back to her 2014 paper)
- while the early presence of non-speech vocalizations appears relatively pre-programmed in humans (i.e., it occurs in the absence of social interaction and in the first few days of life), the use of speech-like productions increases gradually over the first few years and is variable across kids from different SES backgrounds and with different developmental profiles (ASD, hearing impaired), suggesting that it is a learned skill.
- why vocmat? only way to measure production across this entire age range, in which vocalizations change dramatically
- comparative value is high, especially early on: we don't expect lg-specific babbles until 7mo and later (though see Mampe et al. on Fr/De crying and prosody)
- The onset of two-word utterances between 18-24 months has been found to be consistent before: @slobin1970universals
