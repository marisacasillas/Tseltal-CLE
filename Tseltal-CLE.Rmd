...
for (i in 2:nrow(deltas.random.v.va)) {
  deltas.random.v.va$d_xds_mph[i] <-
    deltas.random.v.va$m_xds_mph[i-1] - deltas.random.v.va$m_xds_mph[i] # set up for va - random
...
``` {r sample_differences_cds}
# m/h CHI vocs, # CHI vocs, & voc mat between random, tt, and va
```
# Discussion
