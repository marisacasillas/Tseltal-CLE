...
**[TASK 04: Add paragraph on burstiness]**
Relatedly, 
- the input is STRUCTURED --- going off of means alone misses this point/is lossy as it assumes independence between events
- the relationship between quantity and language development might require a bit more nuance than previously thought: while raw # of tokens feeds into many of the stat learning mechanisms we love to think about, other learning processes may benefit from bursts of linguistic information
- lots of more work needed in this area: contrasting but consistent results at different time scales:
- when massed learning is compared to distributed learning that takes place over a few days, kids do better at word and syntactic learning when info is distributed
- but when mass learning is compared to distributed learning within a single day (e.g., within an interactional context), kids to better with massed learning
- blasi and colleagues (in prep) show that indeed nouns and verbs (and perhaps adjectives, but no or opposite relationships with adverbs, pronouns, and interjections) are used burstily in speech spoken near the child across each of the six diverse languages they investigate. also those burstiness parterns seem to go down with age, though it's unclear why. infrequent lexemes are more bursty, which might explain how rare elements are learned.
- in other ongoing work, Drew & Bergelson (in prep) look at noun usage in children's overheard speech and in their own speech, finding that more frequent nouns were burstier, and that an increased use of nouns was associated with overall burstier speech. <!--how does this link to the description of the rel'n between frequency and spikes in blasi's paper?-->
- similarly, abney, and colleagues (in prep, 2018, 2017) have been looking at different time scales of learning. in recent work (in prep) they analyzed the use of novel noun words in videos recorded on an infant head cam and compared those usage patterns to a measure of learning taken after the interaction (comprehension). found that infants were more likely to learn new labels from bursty structure (similar to schwab & lew-williams, 2016).
- analogous work is taking place in the domain of music: it may be useful to know what the time characteristics of that music exposure are like. in the case of fausey and mendoza (in prep) infants heard ~1hr of music over the day, but only in short bouts of 13 seconds.
- presumably the benefits of massed vs. distributed learning come through different mechanisms, relating to memory consolidation, attention, etc. much more work to be done in this domain!
- in sum, evidence till now leans toward an effect of structured linguistic environment on language learning, so at the very least we may need to more carefully consider how we talk about quantity and language learning, starting with more nuanced characterizations of children's linguistic environments: going beyond means to look at language experience at different timescales (abney "it's time:" cogsci paper).
