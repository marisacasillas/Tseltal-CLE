...
tds.rand.sa.zinb <- glmmTMB(round(tds_mph.sa,0) ~
                              ...
                              I(stthr.std^2) +
                              tchiyr.std:mated.bin +
                              tchiyr.std:nsk.std + # no convgnce w/ this extra term
...
## ODS random sample ####
# zero-inflated negative binomial #----
ods.nonrand.tt.zinb <- glmmTMB(round(ods_mph,0) ~
                           tchiyr.std + mated.bin +
                           hsz.std + nsk.std +
                           I(stthr.std^2) +
                           tchiyr.std:mated.bin +
...
#                           offset(segment_dur) + # weird outcomes
                         ...
                         ziformula=~hsz.std:I(stthr.std^2)+hsz.std, # max: no cvgnce w/ nsk.std
                         family="nbinom1")
#summary(ods.nonrand.tt.zinb)
...
## TDS random sample ####
# zero-inflated negative binomial #----
tds.nonrand.tt.zinb <- glmmTMB(round(tds_mph,0) ~
                           tchiyr.std + mated.bin +
                           hsz.std + nsk.std +
                           I(stthr.std^2) +
                           tchiyr.std:mated.bin +
...
## TDS by speaker age random sample ####
# zero-inflated negative binomial #----
tds.nonrand.tt.sa.zinb <- glmmTMB(round(tds_mph.sa,0) ~
                              tchiyr.std + mated.bin + SpkrAge + 
                              hsz.std + nsk.std +
                              I(stthr.std^2) +
                              tchiyr.std:mated.bin +
...
#                              offset(segment_dur) + # weird outcomes
                            ...
                            ziformula=~I(stthr.std^2)*hsz.std, # no cvgnce w/ nsk.std
                            family="nbinom1")
#summary(tds.nonrand.tt.sa.zinb)
...
prptds.nonrand.tt.beta <- glmmTMB(prp_tds_sqz ~
                              tchiyr.std + mated.bin +
                              hsz.std + nsk.std +
                              I(stthr.std^2) +
                              tchiyr.std:mated.bin +
                            ...
                            family=list(family="beta",link="logit"))
#summary(prptds.nonrand.tt.beta)
#nsk.std                   -1.65586    0.26421  -6.267 3.67e-10 ***
...
#hsz.std                     1.4302     0.7693   1.859  0.06302 . 
```
...
** TO DO NEXT: **
- Add turn taking figs, descriptors, and models (somewhere?) for both rand and tt
