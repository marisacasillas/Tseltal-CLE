...
wordcount         : "11140 (8632 not including references)"
...
``` {r fig1, echo=FALSE, fig.align = "center", fig.cap="The recording vest included an audio recorder in the front horizontal pocket and a camera with a fisheye lens on the shoulder strap.", out.width = '30%'}
