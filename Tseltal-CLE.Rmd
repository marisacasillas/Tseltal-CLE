...
Importantly, children's vocal maturity may be more subject to environmental factors as they grow older. The onset of canonical babbling during the first year appears to be overall relatively stable in response to variable language environments [in typically developing children; REFS; Oller et al., 1994, 1995, 1997; Lee et al., 2018]. However, there is variation in the precise onset age of canonical babble; one recent study showed an onset range of 0;9 to 1;3 among children from a relatively homogenous middle-class sample [REFS McGillion]. The same study showed that the age of canonical babble onset significantly predicted the age onset for first words in the same children (more so than pointing or maternal education). Children's language environments also influence the rate of their vocalization, potentially influencing caregiver CDS patterns [Warlaumont et al., 2014]. As mentioned above, vocabulary size, even very early vocabulary [REFS; Arriaga et al. (1998)] is known to be sensitive to children's language environment, and to be a robust cross-linguistic predictor of children's later syntactic development, including the likelihood that a child between 1;3 and 3;0 has begun to combine words [@frankIPvariability; @marchman2004language].
