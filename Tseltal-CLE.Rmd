...
## Vocal maturity
In response to past reports of infrequent CDS for Mayan children, a common question is whether Tseltal children show significant delays in their language development. We provide an initial answer to this question by comparing the gross trajectory of Tseltal children's early language skills with known early milestones achieved by Western children (Kuhl etc.). To do so, we report on Tseltal the 'vocal maturity' of children's spontaneous speech. This vocal maturity measure is designed to capture the transition from (a) non-canonical babble to canonical babble, (b) canonical babble to first words, and (c) single-word utterances to multi-word speech utterances. Although the transcription data in the corpus we use are not yet lemmatized or morphologically or syntactically annotated, this preliminary measure allows us to achieve a bird's eye view of Tseltal children's speech as it becomes more linguistically complex in the first three years.

That said, children's linguistic development may be more subject to environmental factors as they grow older. Previous work has shown that the onset of canonical babbling is stable in response to wide variation in linguistic experience in typically developing children (e.g., across SES, Oller et al., 1994, 1995; bilinguals-vs-monolinguals, Oller et al. 1997; languages, Lee et al., 2018 ). However, the rate at which infants produce vocalizations may vary across developmental environments (Oller et al., 1994, 1995), and if children's vocal development is further spurred on by caregiver responses to those vocalizations (Warlaumont et al., 2014; McGillion et al., 2017), then early differences in babbling behavior should predict later lexical and syntactic knowledge. The transition between canonical babbling and first words may also be subject to children's experience with language. While first words often closely phonologically approximate non-word babbling (Stoel-Gammon and Cooper, 1984), the size and growth of children's vocabulary is impacted by language experience indices such as SES, birth order, and language (REFS; WORDBANK??) and is predictive of later vocabulary size (REFS; WORDBANK??) which, in turn, predicts other complex language skills, such as early syntactic complexity (REFS). As introduced above, vocabulary size and syntactic complexity have both been linked to children's experience with high frequency and high quality CDS in the past.

Therefore, if we find that Tseltal children hear relatively little CDS, one might expect that the emergence of canonical babble would occur around the same age as it does in Western children (~6–7 months), but that other vocal maturity behaviors shown to be sensitive to input in past work—the rate of vocalization, the emergence and use of single words, and the emergence and use of multi-word utterances—would diverge from known middle-class Western norms.

## The current study {#intro-currentstudy}
We examined the early language experience of 10 Tseltal Mayan children under age 3;0 using daylong photo-linked audio recordings. Prior ethnographic work suggests that Tseltal caregivers do not frequently directly address their children until the children themselves begin to actively initiate verbal interactions [@brown2014interactional; @brown2011cultural]. Nonetheless, Tseltal children develop language with no apparent delays [@brown2011cultural; @brown2014interactional; @liszkowski2012prelinguistic; see also @pye2017comparative]. We provide more details on the community and dataset in the [Methods section](#methods). We analyzed two basic measures of Tseltal children's language environments including: (a) the quantity of speech directed to them (TCDS; target-child-directed speech) and (b) the quantity of other-directed speech (ODS; speech directed to anyone but the target child). We also then coarsely outline children's linguistic development using vocal maturity estimates from their spontaneous vocalizations.
