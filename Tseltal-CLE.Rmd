...
```{r fig2, echo=FALSE, fig.align = "center", fig.cap="Recording duration (black line) and sampled clips (colored boxes) for each recording analyzed, sorted by child age.", message=FALSE, warning=FALSE, fig.height=2.5}
...
Is there room for quick vocmat findings here? See [Figure 9](#fig9).

non-speech sounds 0-3 mo, vowel-like sounds ~3 mo, canonical babbling around 7mo, first words around 12mo (Kuhl 2004)

protophones 2-3mo (Warlaumont 2016; Oller 1980)

proportion of speech-like vocalizations increase from ~0.6 to ~0.85 for TD kids (inclusive high and low SES) between 8 and 48 months (Warlaumont et al. 2014).

```{r fig9, echo=FALSE, fig.cap="Vocal maturity YO.", message=FALSE, warning=FALSE, fig.height=2}
voc.mat.by.age
```
